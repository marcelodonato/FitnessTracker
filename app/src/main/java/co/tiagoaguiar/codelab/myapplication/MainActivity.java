...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mainItems.add(new MainItem(1, R.drawable.ic_baseline_wb_sunny_24, R.string.imc, Color.GREEN));
        mainItems.add(new MainItem(2, R.drawable.ic_baseline_visibility_24, R.string.tmb, Color.YELLOW));
    ...
    private class MainAdapter extends RecyclerView.Adapter<MainAdapter.MainViewHolder> {
        ...
        public void onBindViewHolder(@NonNull MainViewHolder holder, int position) {
            MainItem mainItemsCurrent = mainItems.get(position);
            holder.bind(mainItemsCurrent);
